import { IProject, ITechCategory, TechItem } from '@shared/types';

export const FULL_NAME = 'Пексялев Виталий Викторович';

export const PROFESSION = 'Frontend Developer';

export const TECHNOLOGYS = ['React', 'TypeScript', 'Next.js', 'Redux Toolkit', 'GraphQL', 'Vite'];
...
export const PROJECTS: IProject[] = [
...

  {
    ...
    description: 'Информационная система для мониторинга и управления проектами.',
