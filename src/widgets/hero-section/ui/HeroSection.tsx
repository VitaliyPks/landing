...
import { Download, GitHub, Telegram, Email } from '@mui/icons-material';
...
import { BoxMain, BoxTag, InfoTypography, NameTypography } from './HeroSection.styles';
...
export const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Stack direction="row" flexWrap="wrap" justifyContent="center" gap={1} mb={4}>
      ...
      >
        ...
        >
          ...
          <Button variant="outlined" startIcon={<Email />} component="a" href={`mailto:${EMAIL}`}>
            Email
          </Button>
          <Button
            variant="contained"
            startIcon={<Download />}
            component="a"
            href="./CV_Peksyalev_Vitaliy_Frontend.pdf"
            download
            sx={{
